...
/**
 * 锈蚀草原（dim78 群系 180，plan S2 / 02 §1.1 参数表）。
 * <p>
 * 权重 45；top=锈草(meta0)/filler=锈土(meta1)；高度 0.10/0.28；偶雨（温/雨 0.9/0.2，无雪）；
 * 草色 = 固定锈褐绿 RGB（经方块 BlockProsperitySurface 的 colorMultiplier 邻域均值消费，
 * GT5U BlockDarkWorldPollutedDirt.java:46-62 样板）。
 */

...
public class MTELargeSteamFurnaceGui extends MTESteamMultiBlockBaseGui {

    public MTELargeSteamFurnaceGui(MTESteamMultiBlockBase<?> multiblock) {
        super(multiblock);
    }
    ...
    protected void registerSyncValues(PanelSyncManager syncManager) {
        ...
        syncManager.syncValue(
            "gtsr.tier",
            new IntSyncValue(() -> ((com.miaokatze.gtsr.common.machine.MTELargeSteamFurnace) multiblock).mSetTier));
    }
    ...
    protected ListWidget<IWidget, ?> createTerminalTextWidget(PanelSyncManager syncManager, ModularPanel parent) {
        ...
        return super.createTerminalTextWidget(syncManager, parent).child(IKey.dynamic(() -> {
            ...
            .fullWidth())
            .child(IKey.dynamic(() -> {
                boolean isSuperheated = ((com.miaokatze.gtsr.common.machine.MTELargeSteamFurnace) multiblock)

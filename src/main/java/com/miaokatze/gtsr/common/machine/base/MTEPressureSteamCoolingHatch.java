    ...
    public String[] getDescription() {
        return new String[] { StatCollector.translateToLocal("gtsr.tooltip.pressure_steam_cooling_hatch.name"),
            EnumChatFormatting.AQUA
                + StatCollector.translateToLocal("gtsr.tooltip.pressure_steam_cooling_hatch.capacity")
                + PRESSURE_CAPACITY
                + " L",
            EnumChatFormatting.GREEN
                + StatCollector.translateToLocal("gtsr.tooltip.pressure_steam_cooling_hatch.formula"),
            EnumChatFormatting.YELLOW
                + StatCollector.translateToLocal("gtsr.tooltip.pressure_steam_cooling_hatch.fluid_type"),
            EnumChatFormatting.GRAY + "Output: " + OUTPUT_PER_TICK + " L/tick", EnumChatFormatting.RED
                + StatCollector.translateToLocal("gtsr.tooltip.pressure_steam_cooling_hatch.no_input") };
    }
}

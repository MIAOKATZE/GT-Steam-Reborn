...
public class MTELargeSolarOverpressureArrayOLD extends MTEEnhancedMultiBlockBase<MTELargeSolarOverpressureArrayOLD>
    ...
    private static IStructureDefinition<MTELargeSolarOverpressureArrayOLD> STRUCTURE_DEFINITION = null;
    ...
    public MTELargeSolarOverpressureArrayOLD(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeSolarOverpressureArrayOLD(String aName) {
        super(aName);
    }
    ...
    @Override
    public IStructureDefinition<MTELargeSolarOverpressureArrayOLD> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            final int bronzeCasingIndex = ((BlockCasings1) GregTechAPI.sBlockCasings1).getTextureIndex(10);

            STRUCTURE_DEFINITION = StructureDefinition.<MTELargeSolarOverpressureArrayOLD>builder()
                .addShape(
                ...
                .addElement(
                    ...
                    ofChain(
                        ...
                        onElementPass(
                            t -> {},
                            ofBlocksTiered(
                                MTELargeSolarOverpressureArrayOLD::getCasingTier,
                                ImmutableList.of(
                                    Pair.of(GregTechAPI.sBlockCasings1, 10),
                                    Pair.of(GregTechAPI.sBlockCasings2, 0)),
                                -1,
                                (MTELargeSolarOverpressureArrayOLD t, Integer tier) -> t.tierCasing = tier,
                                (MTELargeSolarOverpressureArrayOLD t) -> t.tierCasing)),
                        buildHatchAdder(MTELargeSolarOverpressureArrayOLD.class).atLeast(OutputHatch, InputHatch)
                ...
                .addElement(
                    'C',
                    ofBlocksTiered(
                        MTELargeSolarOverpressureArrayOLD::getPipeTier,
                        ImmutableList
                            .of(Pair.of(GregTechAPI.sBlockCasings2, 12), Pair.of(GregTechAPI.sBlockCasings2, 13)),
                        -1,
                        (MTELargeSolarOverpressureArrayOLD t, Integer tier) -> t.tierPipe = tier,
                        (MTELargeSolarOverpressureArrayOLD t) -> t.tierPipe))
                .addElement(
                    'D',
                    ofBlocksTiered(
                        MTELargeSolarOverpressureArrayOLD::getGearTier,
                        ImmutableList
                            .of(Pair.of(GregTechAPI.sBlockCasings2, 2), Pair.of(GregTechAPI.sBlockCasings2, 3)),
                        -1,
                        (MTELargeSolarOverpressureArrayOLD t, Integer tier) -> t.tierGear = tier,
                        (MTELargeSolarOverpressureArrayOLD t) -> t.tierGear))
                .addElement(
                    'E',
                    ofBlocksTiered(
                        MTELargeSolarOverpressureArrayOLD::getConductorTier,
                        ImmutableList.of(
                            Pair.of(GregTechAPI.sBlockMetal6, 10),
                            Pair.of(Blocks.gold_block, 0),
                            Pair.of(GregTechAPI.sBlockMetal5, 4)),
                        -1,
                        (MTELargeSolarOverpressureArrayOLD t, Integer tier) -> t.tierConductor = tier,
                        (MTELargeSolarOverpressureArrayOLD t) -> t.tierConductor))
                .addElement(
                    'F',
                    ofBlocksTiered(
                        MTELargeSolarOverpressureArrayOLD::getGlassTier,
                        ImmutableList.of(
                        ...
                        -1,
                        (MTELargeSolarOverpressureArrayOLD t,
                            Integer tier) -> t.tierGlass = Math.max(t.tierGlass, tier),
                        (MTELargeSolarOverpressureArrayOLD t) -> t.tierGlass))
                .addElement(
                    'G',
                    ofBlocksTiered(
                        MTELargeSolarOverpressureArrayOLD::getFrameTier,
                        ImmutableList.of(
                        ...
                        -1,
                        (MTELargeSolarOverpressureArrayOLD t,
                            Integer tier) -> t.tierCasing = Math.max(t.tierCasing, tier),
                        (MTELargeSolarOverpressureArrayOLD t) -> t.tierCasing))
                .build();
        }
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addInfo(EnumChatFormatting.RED + StatCollector.translateToLocal("gtsr.tooltip.old.remove_soon"))
            .addMachineType(StatCollector.translateToLocal("gtsr.tooltip.solar_array.type"))

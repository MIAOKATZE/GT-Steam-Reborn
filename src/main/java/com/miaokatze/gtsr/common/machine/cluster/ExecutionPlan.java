 ...
 * T_粉碎=120t×1.0÷1=120t、T_熔炼=40t，ΣT=160t；
 * 链蒸汽 C=(2000×120+2000×40)÷160=2000 L/s；单物品工作耗时=(120+40)÷20=8 s（物流段另加）；</li>
 * <li>tier0 单链「锻造锤+粉碎」：C=(8000×4+2000×120)÷(4+120)=272000÷124≈2194 L/s——时间加权使长步低耗的
 * 粉碎在均值中占主导；T4 后 unitTier=1 时 C_i×16、T_i÷8（不再约去），加权 C 放大 ×16，
 * 单物品工作耗时缩为 (4+120)÷8÷20=0.775 s；</li>
...
public final class ExecutionPlan {
     ...
     * {@link ClusterParams#PROCESSING_UNIT_TIME_DIVISOR}（T4：1/8/32/64）缩小该 link 时间

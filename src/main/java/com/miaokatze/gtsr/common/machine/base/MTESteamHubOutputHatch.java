...
public class MTESteamHubOutputHatch extends MTEHatchOutput {
    ...
    public String[] getDescription() {
        return new String[] {
            EnumChatFormatting.DARK_AQUA + StatCollector.translateToLocal("gtsr.tooltip.steam_hub_output_hatch.info"),
            EnumChatFormatting.AQUA + StatCollector.translateToLocal("gtsr.tooltip.steam_hub_output_hatch.fluid_type"),

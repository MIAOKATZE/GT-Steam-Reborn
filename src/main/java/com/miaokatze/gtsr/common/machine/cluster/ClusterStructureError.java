...
public class ClusterStructureError implements StructureError {
     ...
     * <p>
     * 语义：延伸链在第 {@code expectedSegment} 段（1 基，1..19）缺失/不完整，且其后仍存在可识别的
    ...
    /** 延伸段断裂错误（expectedSegment 为 1 基延伸段号，1..19）。 */
    ...
    /** 模块冲突错误（segment 为段号 0..19，padId 为 {@link ClusterTopology} 的 PAD_* 值）。 */

 ...
 * <p>
 * 锁定流体：氢氯酸（HydrochloricAcid，{@code Materials.HydrochloricAcid}）。缺流体时本模块增益失效
...
public class MTEUnitSpeedBooster extends MTEBasicAmplifierUnit {
    ...
    /** 锁定流体=氢氯酸（解析集中在上层 {@link #resolveBoosterFluid}，null 安全）。 */
    @Override
     ...
     * {@link ClusterParams#AMPLIFIER_HYDROCHLORIC_ACID_PER_ORE}（经 amplifierFluidLps，L/矿单价口径）与

...
public class MTEPressureSteamStorageUnit extends MTESteamStorageUnit {
    ...
    public String[] getDescription() {
        return new String[] { StatCollector.translateToLocal("gtsr.tooltip.pressure_steam_storage_unit.info"),
            StatCollector.translateToLocal("gtsr.tooltip.pressure_steam_storage_unit.capacity") };
    }
}

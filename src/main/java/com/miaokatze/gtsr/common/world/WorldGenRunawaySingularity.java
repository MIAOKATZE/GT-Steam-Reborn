 ...
 * 生成参数固定为 nature 特殊状态：range 8-16 / speed 1-3 / damage 0 / duration -1(无限) / color white / fxRadius 16。
...
public class WorldGenRunawaySingularity implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator,
        ...
        // NBT 参数：range 8-16 / speed 1-3 / damage 0 / duration -1(无限) / nature(-4) / white / fxRadius 16

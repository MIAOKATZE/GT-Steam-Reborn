...
public class MTESteamCacheNode extends MTEDigitalTankBase {
    ...
    public ITexture[] getTexture(IGregTechTileEntity baseMetaTileEntity, ForgeDirection sideDirection,
        ...
        if (sideDirection == ForgeDirection.UP) {
            return new ITexture[] {
                TextureFactory.of(MACHINE_BRONZE_TOP),
    ...
    protected static boolean isAllowedFluidName(String fluidName) {
        return "steam".equals(fluidName)
            || "ic2steam".equals(fluidName)
            || "ic2superheatedsteam".equals(fluidName);
    }
    ...
    public void addAdditionalTooltipInformation(ItemStack stack, List<String> tooltip) {
        ...
        tooltip.add(
            EnumChatFormatting.AQUA
                ...
                + EnumChatFormatting.YELLOW
                + StatCollector.translateToLocal("gtsgu.tooltip.steam_cache_node.fluid_type.steam"));
        tooltip.add(
            EnumChatFormatting.AQUA

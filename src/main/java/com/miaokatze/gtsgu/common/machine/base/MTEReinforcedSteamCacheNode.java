...
public class MTEReinforcedSteamCacheNode extends MTEDigitalTankBase {

    private static final int CAPACITY = 16_000_000;
    private static final int OUTPUT_RATE_PER_SEC = 1_000_000;
    private static final String LOCKED_FLUID_NAME = "ic2superheatedsteam";
    ...
    protected static boolean isAllowedFluidName(String fluidName) {
        return "ic2superheatedsteam".equals(fluidName);
    }

    @Override
    public boolean isFluidInputAllowed(FluidStack aFluid) {
        return isSuperheatedSteam(aFluid);
    }

    @Override
    public int fill(FluidStack aFluid, boolean doFill) {
        if (aFluid == null || !isSuperheatedSteam(aFluid)) return 0;
    ...
    private static boolean isSuperheatedSteam(FluidStack aFluid) {

...
public class MTESteamFluidDrill extends MTESteamMultiBase<MTESteamFluidDrill> implements ISurvivalConstructable {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(getMachineType())
            .addInfo(StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.info"))
            .addInfo(StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.bronze"))
            .addInfo(StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.steel"))
            .addInfo(
                EnumChatFormatting.RED + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.steam_cost")
            ...
            .addOutputHatch(
                EnumChatFormatting.GOLD + "1"
                    ...
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.any_casing"),
                1)
            .addStructureInfo(
                EnumChatFormatting.WHITE + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.steam_hatch")
            ...
            .addStructureInfo(
                EnumChatFormatting.AQUA + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.output")
                    + EnumChatFormatting.WHITE
                    + BRONZE_MIN_OUTPUT
                    + "-"
                    + BRONZE_MAX_OUTPUT
            ...
            .addStructureInfo(
                EnumChatFormatting.GOLD + "6"
                    + EnumChatFormatting.GRAY
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.bronze_frame"))
            .addStructureInfo(
                EnumChatFormatting.GOLD + "10"
                    + EnumChatFormatting.GRAY
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.bronze_casing"))
            .addStructureInfo("")
            ...
            .addStructureInfo(
                EnumChatFormatting.GOLD + "6"
                    + EnumChatFormatting.GRAY
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.steel_frame"))
            .addStructureInfo(
                EnumChatFormatting.GOLD + "10"
                    + EnumChatFormatting.GRAY
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.steam_fluid_drill.steel_casing"))
            .toolTipFinisher();
        return tt;
    }

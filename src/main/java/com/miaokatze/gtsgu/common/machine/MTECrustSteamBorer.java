...
public class MTECrustSteamBorer extends MTESteamMultiBase<MTECrustSteamBorer> implements ISurvivalConstructable {
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(getMachineType())
            .addInfo(StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.info"))
            .addInfo(StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.bronze"))
            .addInfo(
                EnumChatFormatting.RED + StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.steam_cost")
                    + EnumChatFormatting.WHITE
                    + STEAM_PER_SECOND
                    + " L/s"
                    + EnumChatFormatting.RESET)
            .addInfo(StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.pressure_hatch"))
            .addInfo(StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.dim_limit"))
            .beginStructureBlock(7, 9, 7, false)
            .addOutputBus(
                EnumChatFormatting.GOLD + "1"
                    + EnumChatFormatting.GRAY
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.any_casing"),
                1)
            .addStructureInfo(StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.steam_or_pressure_hatch"))
            .addStructureInfo(
                EnumChatFormatting.GOLD + "42"
                    + EnumChatFormatting.GRAY
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.bronze_frame"))
            .addStructureInfo(
                EnumChatFormatting.GOLD + "20"
                    + EnumChatFormatting.GRAY
                    + " "
                    + StatCollector.translateToLocal("gtsgu.tooltip.crust_steam_borer.bronze_casing"))
            .toolTipFinisher();
        return tt;
    }

...
> 📷 图片待配：更新 SFD/CSB/CMA 三台机器的游戏内截图（现图过时）
...
> 📷 图片待配：6 个单方块节点（缓存节点×4 + 工作节点×2）的游戏内渲染图或合成图
